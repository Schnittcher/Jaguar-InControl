            ...
            if (@$this->GetIDForIdent($Value['key']) != false) {
                switch ($Value['key']) {
                    ...
                    case 'ODOMETER_METER':
                        ...
                        break;
                    case 'DOOR_IS_ALL_DOORS_LOCKED':
                        if ($Value['value'] == 'locked') {
                            $this->SetValue($Value['key'], false);
                        } else {
                            $this->SetValue($Value['key'], true);
                        }
                        break;
                    case 'DOOR_REAR_RIGHT_LOCK_STATUS':
                    case 'DOOR_REAR_LEFT_LOCK_STATUS':
                    case 'DOOR_FRONT_RIGHT_LOCK_STATUS':
                    case 'DOOR_FRONT_LEFT_LOCK_STATUS':
                    case 'DOOR_ENGINE_HOOD_LOCK_STATUS':
                        ...
                        break;
                    case 'DOOR_FRONT_LEFT_POSITION':
                    case 'DOOR_REAR_RIGHT_POSITION':
                    case 'DOOR_FRONT_RIGHT_POSITION':
                    case 'DOOR_REAR_LEFT_POSITION':
                    case 'DOOR_ENGINE_HOOD_POSITION':
                    case 'WINDOW_FRONT_LEFT_STATUS':
                    case 'WINDOW_REAR_LEFT_STATUS':
                    case 'DOOR_BOOT_POSITION':
                    ...
                    case 'DOOR_BOOT_LOCK_STATUS':
                        ...
                        break;
                    case 'THEFT_ALARM_STATUS':
                        if ($Value['value'] == 'ALARM_OFF') {
                            $this->SetValue($Value['key'], false);
                        } else {
                            $this->SetValue($Value['key'], true);
                        }
